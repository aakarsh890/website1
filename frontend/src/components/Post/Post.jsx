...
import CommentCard from '../ComponentCard/CommentCard';
    ...
    <div className="postHeader">
      {
        ...
        <div className="postDetails" >
            <Avatar src={ownerName} alt="User" sx ={{
                height: "3vmax",
                width: "3vmax",
        ...
        <Button style={{color: "black", cursor: "pointer", margin:"1vmax 2vmax"}} onClick={()=> setLikesUser(!likesUser)} disabled = {likes.length===0?true:false}><Typography>{likes.length} likes</Typography></Button>
